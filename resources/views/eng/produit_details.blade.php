...
<div class="banner-bootom-w3-agileits">
	...
	<!---728x90--->
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price"><strong>Mark:</strong> {{$product_by_details->marque}}</span>
					<p><span class="item_price"><strong>Manufacturing material:</strong> {{$product_by_details->matiere_fabrication}}</span>
					<p><span class="item_price"><strong>Origin:</strong> {{$product_by_details->origine}}</span>
					<p><span class="item_price"><strong>Possible guarantee:</strong> {{$product_by_details->garantie_eventuelle}}</span>

					<p><span class="item_price"><strong>Price:</strong>{{$product_by_details->price}} F CFA</span></p>
...
<div class="w3_agile_latest_arrivals">
			<h3 class="wthree_text_info">{{__('msg.Arrivées')}}<span>{{__('msg.en vedette')}}</span></h3>	
			...
			<div class="w3layouts_mail_grid">
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>{{__('msg.LIVRAISON GRATUITE')}}</h3>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
