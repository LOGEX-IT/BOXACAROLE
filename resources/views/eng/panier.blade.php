...
{{ csrf_field() }}
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input required="true" type="text" class="form-control" name="nom" id="inputEmail4" placeholder="Your name">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Phone</label>
      <input required="true" type="text" class="form-control" name="telephone" id="inputPassword4" placeholder="Your phone number">
    </div>
  </div>
  <div class="form-group">
    <label for="inputAddress">Adress</label>
    <input type="text" required="true" class="form-control" name="adresse" id="inputAddress" placeholder="Your Adress">
  </div>    
        <div class="jumbotron" style=" background-color: #ffffff;">
                        <input onclick="location.href='{{URL::to('/')}}'"; class="btn btn-default" type="button"  style="width: auto; " name="" value="Continue purchasing" placeholder="">
