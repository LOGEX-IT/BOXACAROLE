...
<div class="page-head_agile_info_w3l">
	...
	<div class="container">
		<div class="col-md-4 products-left">
         ...
         ?>  
            ...
            <div class="community-poll">
				<h4>{{__('msg.CATEGORIES')}}</h4>
				<div class="swit form">	
					<form>
		<?php foreach($all_published_category_menu as $ev_all_published_menu_category){?>
					<div class="check_box"> 
						<div class="radio"> <label><input onclick="location.href='{{URL::to('/en/product_by_category_en/'.Crypt::encrypt($ev_all_published_menu_category->id))}}'"; type="radio" id="tout_id" name="radio"><i></i>{{__('msg.'.$ev_all_published_menu_category->name)}}</label> 
						</div>
				    </div>
	    <?php }?>

	                <div class="check_box"> 
	         	        <div class="radio"> <label><input onclick="location.href='{{URL::to('/en/product_by_category_en/'.Crypt::encrypt($all_published_category_menu_accessoire->id))}}'"; type="radio" name="radio">
	         	        	<i></i>{{__('msg.'.$all_published_category_menu_accessoire->name)}}</label> 
	         	        </div>
	         	    </div>
					</form>
				</div>
			...
			<div class="community-poll">
				...
				<div class="swit form">	
					...
					<div class="check_box"> <div class="radio"> <label><input type="radio" id="homme_id" name="radio" ><i></i>{{__('msg.HOMMES')}}</label> </div></div>
					<div class="check_box"> <div class="radio"> <label><input type="radio" id="dame_id" name="radio"><i></i>{{__('msg.DAMES')}}</label> </div></div>
					<div class="check_box"> <div class="radio"> <label><input type="radio" id="enfant_id" name="radio"><i></i>{{__('msg.ENFANTS')}}</label> </div></div>
		...
		<div class="col-md-8 products-right">
			...
			<span style="font-style: bold; font-size: 20px;">{{__('msg.Les produits de catégorie')}} <strong style="font-size: 25px; font-style: bold; color: #fc636b;"><< {{__('msg.'.$categorie->name)}} >> <b></b></strong> </span>
				<div class="clearfix"></div>
		</div>
  ...
  <div class="row" id="tout_produit_id" style="display: block;">
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="button" onclick="location.href='{{URL::to('/en/detail_produit/'.Crypt::encrypt($v_product->id))}}'";  name=""
																	 value="{{__('msg.Voir le produit')}}" class="button">
																</fieldset>
															</form>
														</div>
   ...
   <div class="row" id="produit_femme" style="display: none;">
    	@if(count($womens_product_by_category)<1)
          <p style="text-align: center; font-size: 20px; color: red; font-style: bold; margin-top: 100px;">{{__('msg.PAS DE PRODUIT DISPONIBLE')}}</p>
		@endif
...
<div class="w3_agile_latest_arrivals">
			<h3 class="wthree_text_info">{{__('msg.PRODUITS')}}<span> {{__('msg.SIMILAIRES')}}</span></h3>	
										...
										<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="return" value=" ">
																	<input type="hidden" name="cancel_return" value=" ">
																	<input  onclick="location.href='{{URL::to('/en/detail_produit/'.Crypt::encrypt($v_product_footer_by_category->id))}}'"; type="button" name="" value="{{__('msg.Voir le produit')}}" class="button">
																</fieldset>
															</form>
														</div>
