				...
				<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>E-mail</h4>
							<p><span><a href="mailto:info@example.com">commerceagency@gmail.com</a></span></p>
						</div>
					</div>
						...
						<strong>Pour plus d'Informations</strong>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Téléphone </p><span>(228) 93 65 05 02</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>E-Mail </p><a href="mailto:info@example.com">commerceagency@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Localisation </p><a href="mailto:info@example.com">LOME-TOGO</a>
								</div>
								<div class="clearfix"> </div>
							</div>
